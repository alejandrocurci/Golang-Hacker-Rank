...
// it reads an integer (number of strings) and the strings to reverse from the console
// it writes the reversed strings to the specified file
// the env variable is set to "intermediate/tcp_server/out.txt"
func main() {
